...
Every glycemic metric, its definition, and why it's defined that way. Same
format as `docs/data-decisions.md`: one entry per metric decision, newest at
the bottom. Table above is an index.
